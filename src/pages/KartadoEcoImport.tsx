...
import initialData from '@/data/kartado-eco/acompanhamento.json';
...
export function KartadoEcoImport({ children }: { children: (data: Data) => ReactNode }) {
  ...
  const current = saved?.payload ?? initialData;
  return <>
